...
def run(backup_neo4j=True):
    ...
    thinker = Thinker()
    ret = thinker.think('With only +, -, *, /, how to get 24 from 4, 5, 6, 10?')
    # ret = thinker.think('7 orange and 3 apple cost 44 dollars and 6 orange and 6 apple cost 48 dollars, what are the prices of apple and orange respectively?')
